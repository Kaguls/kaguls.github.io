...
가로에서 옆으로 뻗어져나가는 세로데이터

=>  `종류, 이름, 가격`은 열-컬럼(colmn) 
...
행은 행1 행 2 행3 이니까 [123] [456] [789]

열은 열1 열2 열3 이니까 [147] [258] [360]



그러면 여기 최상단에 제목이 추가되면 행(Row)인가 열(column)인가? 퀴즈
